...
export const deliveryMethodSchema = z.object({
    ...
    freeFromPrice: z.preprocess(emptyToNull, z.coerce.number().min(0, 'Must be 0 or more').nullable()),
});
...
export const paymentMethodSchema = z.object({
    name: z.string().trim().min(1, 'Name is required').max(100, 'Too long'),
    feePercentage: z.coerce.number().min(0, 'Must be between 0 and 100').max(100, 'Must be between 0 and 100'),
