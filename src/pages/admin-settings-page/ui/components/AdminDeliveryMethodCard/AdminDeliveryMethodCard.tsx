...
import { AdminDeliveryMethod, UpdateDeliveryMethodPayload, useUpdateAdminDeliveryMethodMutation } from '@/entities/admin';
...
export const AdminDeliveryMethodCard = ({ method }: AdminDeliveryMethodCardProps) => {
    ...
    return (
        <div className={style['admin-delivery-method-card']}>
            ...
            <form className={style['admin-delivery-method-card__form']} onSubmit={handleSubmit(onSubmit)} noValidate>
