...
export const DeliveryOption = memo<DeliveryOptionProps>(
  ({ option, isSelected, cartTotal, handleSelect }) => {
      ...
      >
        ...
        <div className={style['delivery-option__info']}>
          <span className={style['delivery-option__label']}>
            {option.label}
            {!option.isActive && (
              <span className={style['delivery-option__badge']}>Unavailable</span>
            )}
          </span>
