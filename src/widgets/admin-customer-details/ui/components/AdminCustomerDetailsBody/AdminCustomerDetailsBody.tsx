...
export const AdminCustomerDetailsBody: FC<AdminCustomerDetailsBodyProps> = ({ customer }) => {
  ...
  const tiles = [
    ...
    },
    {
      ...
      value: formatNullableDate(customer.lastOrderAt),
      label: 'Last order',
    },
    {
      key: 'registered',
      icon: <LuCalendarCheck />,
      value: formatNullableDate(customer.registeredAt),
      label: 'Registered',
    },
  ];
            ...
            {orders.map((order) => (
              ...
              >
                ...
                <span className={style['body__order-meta']}>
                  <span className={style['body__order-total']}>
        ...
        <div className={style['body__activity-section']}>
          ...
          {isAuditLoading ? (
            ...
            <>
              ...
              />
              <Link
                href={`/admin/audit?actor=${customer.id}`}
                className={style['body__activity-link']}
              >
                View all activity
              </Link>
            </>
