...
export const FooterAbout: React.FC = () => (
  <div className={styles.footer__about}>
    ...
    <p className={styles.footer__description}>
      A fully responsive e-commerce SPA with glassmorphism aesthetics, real-time URL-synced search,
      a persistent Redux cart, Wishlist, and complete Checkout & Order history powered by Supabase
      integration.
    </p>
