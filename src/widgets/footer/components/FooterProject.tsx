...
import { RiGithubFill, RiTelegramFill, RiLinkedinBoxFill, RiShareBoxLine } from 'react-icons/ri';
...
export const FooterProject: React.FC = () => (
  <div className={styles.footer__socials}>
    ...
    <h3 className={`${styles.footer__title} ${styles.footer__titleConnect}`}>Connect</h3>
