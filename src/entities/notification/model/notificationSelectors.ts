...
export const selectPendingCount = createSelector([selectNotificationState], (notification) =>
  notification.isOffline ? notification.queue.length : Math.max(notification.queue.length - 1, 0),
);
