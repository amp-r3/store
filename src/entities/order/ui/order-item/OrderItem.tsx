...
export const OrderItem: React.FC<OrderItemProps> = React.memo(
  ({ item, onClose, linkToProduct = true }) => {
    ...
    return (
      <article className={style['order-item']}>
        ...
        <div className={style['order-item__price-block']}>
          ...
          <strong className={style['order-item__total-price']}>{formatPrice(itemTotal)}</strong>
        </div>
      </article>
    );
  },
