...
export const ReviewCard = ({ review, isCurrentUser, onEdit }: ReviewCardProps) => {
  ...
  return (
    <article
      className={`${style['review-card']} ${isCurrentUser ? style['review-card--current-user'] : ''}`}
    >
      ...
      <div
        className={`${style['review-card__header']} ${isCurrentUser ? style['review-card__header--with-menu'] : ''}`}
      >
        <div className={style['review-card__user']}>
          ...
          <div className={style['review-card__author-info']}>
            ...
            {isCurrentUser ? (
              <span
                className={`${style['review-card__badge']} ${style['review-card__badge--own']}`}
              >
      ...
      <div className={style['review-card__footer']}>
        <div className={style['review-card__helpful-wrapper']}>
          ...
          >
            ...
            <span>Helpful</span>
            <span className={style['review-card__helpful-count']}>({review.helpfulCount})</span>
          </button>
          {likeError && (
            <span className={style['review-card__error-msg']} role="alert">
              ...
              {!user && (
                <>
                  {' '}
                  <Link href="/login" className={style['review-card__error-link']}>
                    Sign in
                  </Link>
                </>
              )}
