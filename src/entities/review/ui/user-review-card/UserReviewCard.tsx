  ...
  return (
    <article className={style['user-review-card']}>
      ...
      <div className={style['user-review-card__body']}>
        <div className={style['user-review-card__summary']}>
          ...
          <div className={style['user-review-card__meta']}>
            ...
            <time dateTime={review.date}>{formatDate(review.date, 'medium')}</time>
            {review.isEdited && <span className={style['user-review-card__edited']}>(edited)</span>}
      ...
      <footer className={style['user-review-card__footer']}>
        <button type="button" className={style['user-review-card__action']} onClick={handleEdit}>
