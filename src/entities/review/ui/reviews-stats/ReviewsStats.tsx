...
export const ReviewsStats: FC<ReviewStatsProps> = ({ stats, activeRating, onRatingChange }) => {
  ...
  return (
    <div className={style['reviews-stats']}>
      ...
      <div
        className={style['reviews-stats__distribution']}
        role="group"
      ...
      >
        ...
        {distribution.map((dist) => (
          ...
          >
            <span className={style['reviews-stats__dist-label']}>{dist.stars}★</span>
            ...
            <span className={style['reviews-stats__dist-value']}>{dist.percentage}%</span>
            <span className={style['reviews-stats__dist-count']}>({dist.count})</span>
          </button>
        ))}
      </div>
    </div>
