...
export async function fetchReviews(
    ...
    { productId, page = 1, limit = REVIEWS_PAGE_SIZE, sort = 'newest', rating = null }: ReviewsQueryArgs
...
export async function fetchReviewStats(db: SupabaseClient<Database>, productId: number): Promise<ReviewRatingStats> {
