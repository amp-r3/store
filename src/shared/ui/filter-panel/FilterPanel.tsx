...
export const FilterPanel = ({ search, actions, activeCount = 0, label = 'Filters', children }: FilterPanelProps) => {
    ...
    return (
        <div className={style.panel}>
            ...
            <div id={filtersId} className={`${style.panel__filters} ${isExpanded ? style['panel__filters--expanded'] : ''}`}>
                <div className={style.panel__filters_inner}>
                    {children}
                </div>
            </div>
        </div>
