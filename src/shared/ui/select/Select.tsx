...
export const Select = ({
  ...
  const triggerClassName = isBadge
    ...
    : [style.control, isToolbar ? style.controlToolbar : '', error ? style.controlError : '']
        .filter(Boolean)
        .join(' ');
  ...
  return (
    <div
      className={[
        style.wrapper,
        isToolbar ? style.wrapperToolbar : '',
        isBadge ? style.wrapperBadge : '',
      ]
        .filter(Boolean)
        .join(' ')}
    >
      <label
        htmlFor={selectId}
        className={[style.label, hideLabel ? 'sr-only' : ''].filter(Boolean).join(' ')}
      >
        {label}
      ...
      >
        ...
        >
          ...
          <SelectPrimitive.Value
            className={isBadge ? style.valueBadge : style.value}
              ...
              {options.map((option) => (
                ...
                >
                  ...
                  <SelectPrimitive.ItemIndicator
                    className={isBadge ? style.itemBadgeCheck : style.itemIndicator}
                  >
