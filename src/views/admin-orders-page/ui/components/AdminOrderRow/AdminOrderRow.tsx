...
export const AdminOrderRow = memo(({ order, transitions, onOpenDetails }: AdminOrderRowProps) => {
  ...
  const allowedPaymentValues = transitions
    ? (transitions.payment[order.paymentStatus] ?? [])
    : undefined;
  const allowedDeliveryValues = transitions
    ? (transitions.delivery[order.deliveryStatus] ?? [])
    : undefined;
  ...
  return (
    <article role="listitem" className={style['admin-order-row']}>
      <div className={style['admin-order-row__cell']}>
        ...
        <span className={style['admin-order-row__date']}>
      ...
      <div className={style['admin-order-row__cell']}>
        ...
        <span className={style['admin-order-row__customer-name']}>
          {firstName} {lastName}
        </span>
      ...
      <div className={style['admin-order-row__cell']}>
        ...
        <span className={style['admin-order-row__items']}>
      ...
      <div className={style['admin-order-row__cell']}>
        ...
        <span className={style['admin-order-row__cell-label']} aria-hidden="true">
          Payment
        </span>
