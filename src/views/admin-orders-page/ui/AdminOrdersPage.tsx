...
export const AdminOrdersPage = () => {
  ...
  const orderByIdResult = useGetAdminOrderByIdQuery(orderId ?? '', {
  ...
  const activeFilterCount = [status !== 'all', !!search, !!dateFrom, !!dateTo].filter(
    Boolean,
  ).length;

  return (
    <>
      <SectionHeader title="Orders" subtitle="Every order placed in the store." />
