...
export const AdminProductFormPage = () => {
    ...
    const { data: product, isLoading, error } = useGetAdminProductByIdQuery(productId!, { skip: !productId });
    ...
    return (
        <>
            <SectionHeader
                ...
                subtitle={productId ? 'Update this product\'s details.' : 'Add a new product to the catalog.'}
            />
