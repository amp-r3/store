            ...
            {isLoading || !summary ? (
                ...
                <>
                    <DonutChart
                        ...
                        segments={[
                            { key: 'net', label: 'Net to store', value: summary.itemsSubtotal, colorVar: '--chart-series-1' },
                            { key: 'delivery', label: 'Delivery collected', value: summary.deliveryCollected, colorVar: '--chart-series-3' },
                            { key: 'fees', label: 'Payment fees', value: summary.paymentFees, colorVar: '--chart-series-2' },
                        ]}
                    />
