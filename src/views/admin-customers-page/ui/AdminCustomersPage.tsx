...
export const AdminCustomersPage = () => {
  ...
  const customerByIdResult = useGetAdminCustomerByIdQuery(customerId ?? '', {
    skip: !customerId || !!customerFromList,
  });
  ...
  return (
    <>
      <SectionHeader title="Customers" subtitle="Everyone who's registered in the store." />
      ...
      <AdminCustomerRoleModal
        ...
        onOpenChange={(open) => {
          if (!open) setChangingRoleCustomer(null);
        }}
