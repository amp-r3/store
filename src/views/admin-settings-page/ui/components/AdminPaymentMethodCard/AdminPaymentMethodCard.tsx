...
import { AdminPaymentMethod, UpdatePaymentMethodPayload, useUpdateAdminPaymentMethodMutation } from '@/entities/admin';
...
export const AdminPaymentMethodCard = ({ method }: AdminPaymentMethodCardProps) => {
    ...
    const exampleFee = EXAMPLE_ORDER_TOTAL * ((Number(feePercentage) || 0) / 100) + (Number(feeFixed) || 0);
